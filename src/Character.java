...
public class Character
{
  ...
  /**
   * Class constructor that initiates all the object's values <br>
  ...
  /**
   * Return method that returns the character sprite depending on which way the character is facing <br>
  ...
  /**
   * Return method that returns the character's row value <br>
   * Updates 3.0 - method created
   * 
  ...
  /**
   * Return method that returns the character's column value <br>
   * Updates 3.0 - method created
   * 
  ...
  /**
   * Return method that returns whether or not this character has been talked to <br>
  ...
  /**
   * Void method that sets the way that the character is facing <br>
   * Updates 3.0 - method created
   * 
  ...
  /**
   * Void increases private variable count by one for subclasses <br>
   * Updates 4.0 - method created
   */
  ...
  /**
   * Void method that sets the total number of current dialogue lines <br>
   * Updates 4.0 - method created
   * 
  ...
  /**
   * Void method that updates the Character (only used in subclasses) <br>
   * Updates 4.0 - method created
   * 
  ...
  /**
   * Return method that checks if the character is crucial to the storyline at a particular stage (only used in subclasses) <br>
   * Updates 4.0 - method created
   * 
   * @param stage the current stage of the game
